...
const whyUs = [
  { icon: Palette, title: "Retail-Grade Design", body: "Designers from retail backgrounds co-create collections from concept to tech-pack." },
  ...
  { icon: ShieldCheck, title: "Total Quality Management", body: "Dedicated QC and manufacturing supervision teams at every facility." },
  { icon: Boxes, title: "25+ Partner Factories", body: "Own knits/jersey factory plus a vetted network across India." },
  { icon: Leaf, title: "Sustainable Sourcing", body: "Recycled yarns, eco chemicals and carbon neutral partner units." },
];
  ...
  return (
    <>
      ...
      <section className="relative min-h-[92vh] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[image:var(--gradient-navy)] opacity-30" />
        <div className="container-x relative flex min-h-[92vh] flex-col justify-center py-32 text-primary-foreground">
          ...
          <Reveal delay={120}>
            <h1 className="mt-6 max-w-4xl text-4xl leading-[1.05] sm:text-5xl md:text-7xl">
              ...
              <span className="text-accent">Global Fashion Brands</span>
            </h1>
          </Reveal>
          <Reveal delay={240}>
            <p className="mt-8 max-w-2xl text-base leading-relaxed text-primary-foreground/80 md:text-lg">
              Premium apparel manufacturing · Uniform solutions · Fashion
              accessories · Export quality products. Driven by our robust
              Design-to-Delivery model, an in-house knits factory and 25+
              partner units across India.
            </p>
          </Reveal>
          <Reveal delay={360}>
        ...
        <div className="container-x grid items-center gap-16 lg:grid-cols-2">
            ...
            <div className="relative">
              ...
              <div className="absolute -right-4 -bottom-8 hidden max-w-56 rounded-xl bg-primary p-6 text-primary-foreground shadow-[var(--shadow-lift)] sm:block">
                ...
                <p className="mt-2 text-xs leading-relaxed text-primary-foreground/70">
                  Design to Delivery — one accountable partner from concept to
                  warehouse.
                </p>
              </div>
            </div>
          ...
          <Reveal delay={140}>
            <SectionHead
              ...
              body="We drive product design, development and manufacturing through our robust D2D model. Our capabilities include our own knits/jersey factory and a network of over 25 partner factories — a supply chain built for smaller MOQs and shorter lead times."
            />
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {categories.map((cat, i) => (
              <Reveal key={cat.name} delay={i * 80}>
                <Link
                  to="/products"
                  className="surface-card surface-card-hover group block h-full overflow-hidden p-8"
                >
            ...
            <Reveal>
              ...
              <dl className="mt-10 grid gap-8 sm:grid-cols-2">
                {[
                  ...
                  <div key={t}>
                    <dt className="font-[family-name:var(--font-display)] text-sm font-semibold text-accent">
                      {t}
                    </dt>
      ...
      <section className="bg-secondary py-24">
        <div className="container-x">
          <Reveal>
            <SectionHead
              eyebrow="Why Choose ASPL"
              title="A partner brands keep coming back to"
            />
          </Reveal>
        ...
        <div className="container-x">
          <Reveal>
            <SectionHead
              ...
              title="Built to serve every side of the supply chain"
            />
          </Reveal>
        ...
        <div className="container-x grid items-center gap-16 lg:grid-cols-2">
          <Reveal>
            <SectionHead
              ...
              title="Responsible sourcing across every programme"
            />
        ...
        <div className="container-x">
          <Reveal>
            <SectionHead
              ...
              title="Compliance at our manufacturing facilities"
            />
          </Reveal>
      ...
      <section className="overflow-hidden bg-background py-20">
        <div className="container-x">
          <Reveal>
            <SectionHead
              eyebrow="Clients"
              title="Brands that we are associated with"
            />
          </Reveal>
        </div>
      ...
      <section className="relative overflow-hidden bg-[image:var(--gradient-navy)] py-24 text-primary-foreground">
        <div
          aria-hidden
          className="absolute -bottom-32 -left-24 h-96 w-96 rounded-full bg-accent/15 blur-3xl"
        />
        <div className="container-x relative text-center">
          <Reveal>
            ...
            <p className="mx-auto mt-6 max-w-xl text-base text-primary-foreground/75">
              Share your brief and our team will come back with fabric options,
              costing and a delivery plan.
            </p>
            <Link
              to="/contact"
