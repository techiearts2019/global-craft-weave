    ...
    >
      <div className="container-x flex items-center justify-between gap-6">
        ...
        <div className="hidden items-center gap-4 lg:flex">
          ...
          <Link
            to="/contact"
            className="rounded-lg bg-[image:var(--gradient-gold)] px-5 py-2.5 text-sm font-semibold text-accent-foreground shadow-[var(--shadow-soft)] transition-transform duration-300 hover:-translate-y-0.5"
          >
            Request a Quote
          </Link>
        </div>
